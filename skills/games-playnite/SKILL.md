...
Both sides exchange one canonical JSON (defined in `~/game-ownership/playnite.py`). Because
...
1. `python3 ~/game-ownership/playnite_export.py` → writes `ludodex_to_playnite.json`
