...
the ``npsso`` token, exactly like the Epic/EA connect flow:
  ...
  python3 psn_owned.py --npsso '<npsso|json|url>'  # cache tokens, verify
  python3 psn_owned.py --whoami                     # verify auth only
  python3 psn_owned.py                              # print owned games TSV
  python3 psn_owned.py > psn_games.tsv              # (update.sh does this)
