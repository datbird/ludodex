...
Providers (in increasing cost; later ones gap-fill what earlier ones lack):
  ...
  * steamgriddb — community grids/heroes/logos/icons. API key required; THROTTLED,
  ...
  python3 ludodex/media_fetch.py                       # steam + igdb (cheap)
  python3 ludodex/media_fetch.py --provider steam
  python3 ludodex/media_fetch.py --steamgriddb [--limit N]   # gap-fill (opt-in, slow)
"""
import json
import os
import re
