...
Sources
  ...
  python3 ludodex/scores_fetch.py all            # every source, then recompute
  python3 ludodex/scores_fetch.py igdb           # one source
  python3 ludodex/scores_fetch.py steam --metacritic --refresh --limit 200
"""
import json
import os
import ssl
