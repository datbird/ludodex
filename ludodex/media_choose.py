...
bytes, falling back to the live reference for anything not yet materialized.
  ...
  python3 ludodex/media_choose.py                       # select chosen (no downloads)
  python3 ludodex/media_choose.py --materialize          # + pull chosen bytes into repo
  python3 ludodex/media_choose.py --materialize --kind cover --limit 500
"""
import hashlib
import os
import shutil
