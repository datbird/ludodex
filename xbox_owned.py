...
an empty list — so titlehub title history is used, like other 3rd-party tools.)
  ...
  python3 xbox_owned.py --code '<code|url|json>'  # cache tokens, verify
  python3 xbox_owned.py --whoami                  # verify auth (prints gamertag)
  python3 xbox_owned.py                           # print owned games TSV
