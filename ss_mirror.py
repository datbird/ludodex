...
works while a multi-day walk is in progress.
  ...
  python3 ss_mirror.py --walk                  # resume; stops at the daily quota
  python3 ss_mirror.py --walk --max-requests N # bounded chunk
  python3 ss_mirror.py --walk --until-id N     # phase 1 = the dense half
  python3 ss_mirror.py --status
  python3 ss_mirror.py --systems               # (re)build the SS->IGDB platform map
"""
import json
import os
import sqlite3
